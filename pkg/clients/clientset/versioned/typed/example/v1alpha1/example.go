...
type ExampleInterface interface {
	Create(ctx context.Context, example *v1alpha1.Example, opts v1.CreateOptions) (*v1alpha1.Example, error)
	Update(ctx context.Context, example *v1alpha1.Example, opts v1.UpdateOptions) (*v1alpha1.Example, error)
	UpdateStatus(ctx context.Context, example *v1alpha1.Example, opts v1.UpdateOptions) (*v1alpha1.Example, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.Example, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ExampleList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Example, err error)
	ExampleExpansion
}
...
func newExamples(c *ProductV1alpha1Client, namespace string) *examples {
	return &examples{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *examples) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExampleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ExampleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *examples) UpdateStatus(ctx context.Context, example *v1alpha1.Example, opts v1.UpdateOptions) (result *v1alpha1.Example, err error) {
	result = &v1alpha1.Example{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
