...
type ExampleLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.Example, err error)
...
// List lists all Examples in the indexer.
func (s *exampleLister) List(selector labels.Selector) (ret []*v1alpha1.Example, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Example))
	})
	return ret, err
}
...
type ExampleNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.Example, error)
...
// List lists all Examples in the indexer for a given namespace.
func (s exampleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Example, err error) {
...
// Get retrieves the Example from the indexer for a given namespace and name.
func (s exampleNamespaceLister) Get(name string) (*v1alpha1.Example, error) {
